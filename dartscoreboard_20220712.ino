...
unsigned long t_u32=0;
byte State_Machine_u8=0;
...
void loop() {
  ...
  repeatedly: Write_LCD();
  sprintf(LCD_Lines[0],"Text Test");
  switch(State_Machine_u8)
     {
            case 0x00:
                  sprintf(LCD_Lines[1],"Start");
                  t_u32=millis()+1000;
                  State_Machine_u8=0x10;
              break;
             case 0x10:
                 if(t_u32<millis())
                    State_Machine_u8=0x20;
               break;
            case 0x20:
                  sprintf(LCD_Lines[1],"              JA");
                  t_u32=millis()+1000;
                  State_Machine_u8=0x30;
              break;
             case 0x30:
                 if(t_u32<millis())
                    State_Machine_u8=0x40;
               break;
            
            case 0x40:
                  sprintf(LCD_Lines[1],"Nein");
                  t_u32=millis()+1000;
                  State_Machine_u8=0x50;
              break;
             case 0x50:
                 if(t_u32<millis())
                    State_Machine_u8=0x00;
               break;   
